...
?>
    ...
    <div class="row">
        ...
        <div class="py-1">
            <h1 class="mb-0 text-white">Add Product</h1>
        </div>
        </div>
        <!-- Data content start-->
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <form action="add-product.php" method="post">
                    <?php if ( count($errors) === 0 && !empty($success['prod_add_success']) ): ?>
                        <div class="gen-form-success"> <?php echo $success['prod_add_success']; ?> </div>
                    <?php endif; ?>
                        <?php if ( count($errors) > 0 && !empty($errors['prod_add_fail']) ): ?>
                        <div class="gen-form-errors"> <?php echo $errors['prod_add_fail']; ?> </div>
                    <?php endif; ?>
                    ...
                    <div class="form-group">
                        <input class="btn btn-fms my-4 btn-block" type="submit" value="Add Product" name="add-product" >
                    </div>
                </form>
                </div>
            </div>
