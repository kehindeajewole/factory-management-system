...
?>
    ...
    <div class="row">
        ...
        <div class="py-1">
            <h1 class="mb-0 text-white">Edit User</h1>
        </div>
        </div>
        <!-- Data content start-->
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6">
                <form action="edit-user.php?ueid=<?php echo $_GET['ueid']; ?>" method="post">
                    <?php if ( count($errors) === 0 && !empty($success['user_edit_success']) ): ?>
                        <div class="gen-form-success"> <?php echo $success['user_edit_success']; ?> </div>
                    <?php endif; ?>
                        <?php if ( count($errors) > 0 && !empty($errors['user_edit_fail']) ): ?>
                        <div class="gen-form-errors"> <?php echo $errors['user_edit_fail']; ?> </div>
                    <?php endif; ?>
                    ...
                    <div class="form-group">
                        <input class="btn btn-fms my-4 btn-block" type="submit" value="Update User" name="edit-user" >
                    </div>
                </form>
                </div>
            </div>
