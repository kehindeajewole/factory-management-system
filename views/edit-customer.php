...
?>
    ...
    <div class="row">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6">
                <form action="edit-customer.php?ceid=<?php echo $_GET['ceid']; ?>" method="post">
                    <?php if ( count($errors) === 0 && !empty($success['cust_edit_success']) ): ?>
                        <div class="gen-form-success"> <?php echo $success['cust_edit_success']; ?> </div>
                    <?php endif; ?>
                        <?php if ( count($errors) > 0 && !empty($errors['cust_edit_fail']) ): ?>
                        <div class="gen-form-errors"> <?php echo $errors['cust_edit_fail']; ?> </div>
                    <?php endif; ?>
                    <div class="form-group">
                        <input type="hidden" name="cust-id" value="<?php echo $custId ;?>">
                    ...
                    <div class="form-group">
                        <input class="btn btn-fms my-4 btn-block" type="submit" value="Update Customer" name="edit-customer" >
                    </div>
                </form>
                </div>
            </div>
