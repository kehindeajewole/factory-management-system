...
?>
    ...
    <div class="row">
        ...
        <div class="py-1">
            <h1 class="mb-0 text-white">Add Supplier</h1>
        </div>
        </div>
        <!-- Data content start-->
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <form action="add-supplier.php" method="post">
                    <?php if ( count($errors) === 0 && !empty($success['sup_add_success']) ): ?>
                        <div class="gen-form-success"> <?php echo $success['sup_add_success']; ?> </div>
                    <?php endif; ?>
                        <?php if ( count($errors) > 0 && !empty($errors['sup_add_fail']) ): ?>
                        <div class="gen-form-errors"> <?php echo $errors['sup_add_fail']; ?> </div>
                    <?php endif; ?>
                    ...
                    <div class="form-group">
                        <label for="coy-addy" class="form-control-label">Address</label>
                    ...
                    <div class="form-group">
                        <label for="coy-email" class="form-control-label">Email</label>
                    ...
                    <div class="form-group">
                        <input class="btn btn-fms my-4 btn-block" type="submit" value="Add Supplier" name="add-supplier" >
                    </div>
                </form>
                </div>
            </div>
